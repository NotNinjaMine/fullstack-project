  ...
  return notify(
    {
      ...
      message: approved
        ...
        : `Your ${leave.leave_type} leave (${range}) has been rejected.`,
      leaveRequestId: leave.id,
      ...
      emailBody: approved
        ...
        : 'Your leave request has been rejected. Sign in to view details.',
      whatsappBody: approved
        ? `HR Leave: Your ${leave.leave_type} leave (${range}) was APPROVED. ${appLink()}/leave`
        : `HR Leave: Your ${leave.leave_type} leave (${range}) was REJECTED. ${appLink()}/leave`,
      telegramBody: tg,
    },
    client
  );
