module.exports = (sequelize, DataTypes) => {
  // UC-25: personal security log. Every login, logout, failed attempt,
  // password change, and session revoke is recorded and retained for a year.
  // Also drives the 3-strikes / 15-minute lockout (counted in code).
